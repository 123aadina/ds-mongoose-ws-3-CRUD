...
app.get("/todos", (req, res) => {
    console.log("todos route called")
...
app.patch("/todos/:id", (req, res) => {
    ...
    let updatedTodos = req.body
    Todo.findByIdAndUpdate(todoId, updatedTodos, {new: true}).then( todo=> { 
        console.log(todo)
        res.send(todo)
    })
})
...
app.delete("/todos/:id", (req, res) => {
    console.log("delet route called")

    todoId = req.params.id
    let deletedTodos = req.body
     Todo.findByIdAndDelete(todoId, deletedTodos).then( todo=> { 
        console.log(todo)
        res.send(todo)
    })
})
